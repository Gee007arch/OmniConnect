...
import { comingSoonItems } from '@/data/site-content'
              ...
              {comingSoonItems.map((item, index) => (
                ...
                >
                  <a href={item.href} target="_blank" rel="noreferrer">
                    <div className="comingsoon-poster-shell">
                      <img
                        src={item.poster}
                        alt={item.title}
                  ...
                  <div className="comingsoon-meta-3d">
                    <a
                      href={item.href}
                      target="_blank"
                      rel="noreferrer"
                    ...
                    <div className="mt-4 flex flex-col items-center gap-3 md:flex-row">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex h-10 w-full items-center justify-center rounded-full bg-blue-600 px-5 text-sm font-semibold uppercase tracking-[0.22em] text-white transition hover:bg-blue-500 md:w-auto"
                      >
                      ...
                      <a  
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex h-10 w-full items-center justify-center rounded-full border border-white/20 bg-white/5 px-5 text-sm font-semibold uppercase tracking-[0.22em] text-white transition hover:bg-white hover:text-black md:w-auto"
                      >
